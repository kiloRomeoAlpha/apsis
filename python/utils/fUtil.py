...
# $Id: fUtil.py,v 1.24 2005/11/08 21:30:04 anderson Exp $
# ---------------------------------------------------------------------
# ACS pipeline generic interface to some kind of image package which
# is pyfits right now.
#
__version__      = '$Revision: 1.24 $ '[11:-3]
__version_date__ = '$Date: 2005/11/08 21:30:04 $ '[7:-3]
__author__       = "Ken Anderson, anderson@pha.jhu.edu; J. Blakeslee"
...
def fixDrzHeader(fpath,module,date,file_type="SCI",addCards=None):
    ...
    # (i.e. the _drz_sci.fits image).  The second pattern will match all context specific keywords 
    # (CONnnnn) and should only be kept in the context image (i.e. _drz_scI_context.fits) we need 
