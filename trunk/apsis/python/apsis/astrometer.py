...
class gscMatchup:
    ...
    def __init__(self,obs):
        ...
        self.pardir         = obs.newpar
        self.Imagedir       = obs.newfits         # path to fits Images/ dir
        self.Imagedir       = obs.newfits         # path to fits Images/ dir
    ...
    def applyCorrs(self):
        ...
        for imlist in [self.sciImlist, self.ctxImlist, self.wgtImlist, self.rmsImlist]:
            for im in imlist:
                ...
                ff[0].header.add_comment("astrom: CRVAL1,CRVAL2 corrected by apsis astrometer module.")
    ...
    def makeObjcats(self):
        ...
        for imsci in self.sciImlist:
            ...
            objcat = imsci.split("_drz")[0]+'.obj'
            projcat = imsci.split("_drz")[0]+'.proj'
            fp = open(objcat,'w')
            ngood=0
    ...
    def writeXml(self):
        """This module must remark the image headers with Apsis xml.
        """
        curdir = os.getcwd()
        os.chdir(self.Imagedir)
