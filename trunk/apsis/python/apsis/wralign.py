...
class alignImage:
    ...
    def __init__(self,obs,extRefIm=0,idcTab=None,Edgebuf=12,irafSkyToo=1,nebula=0,
        ...
        self.GlobalBlock = GlobalBlock(obs.logfile,obs.newalign,obs.newpar,obs.newfits)
    ...
    def match(self,intRef='',superalign=None,retry=0):
        TAlignParam = StandAlignParam(superalign)
        self.TAlign.match(TAlignParam,self.notrot,intRef,retry)
