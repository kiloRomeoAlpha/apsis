...
class Exposure:
    ...
    def __init__(self,expname, idckey=None,new=no,wcs=None,mask=None,nchips=None):
...
class Pattern:
    ...
    def addMembers(self,filename):
        ...
        for i in range(self.nmembers):
            ...
            self.members.append(Exposure(extname, idckey=self.idckey, mask=maskname, nchips=self.nmembers))
    ...
    def buildProduct(self,filename,output):
        ...
        output_wcs = self.buildMetachip(psize=_psize,orient=_rot)
    ...
    def buildMetachip(self,psize=None,orient=None):
        ...
        if orient != None:
            meta_wcs.orient = _geo_ref.wcslin.orient
    ...
    def buildPars(self,ref=None,def_wcs=None):
        ...
        if ref != None:
            ...
            _prod_wcs = self.product.geometry.wcs
        ...
        for member in self.members:
            ...
            parameters['xsh'] = offsets['xsh'] + _delta_x
            parameters['ysh'] = offsets['ysh'] + _delta_y
            ...
            parameters['rot'] = in_wcs.orient - ref_wcs.orient
    ...
    def computeCubicCoeffs(self):
        ...
        for img in self.members:
            ...
            if _ikey == 'trauger':
                ...
                _ratio = 1.
                # correct coefficients to calculate pixel positions
                # rotated to PC orientation for all chips.
                if img.chip != '1':
                    _theta = _reftheta - _refdata['theta']
                    _cx = drutil.rotateCubic(_model.cx,_theta)
                    _cy = drutil.rotateCubic(_model.cy,_theta)
                    _model.cx = _cx
                    _model.cy = _cy 
...
class DitherProduct(Pattern):
    ...
    def buildPars(self,ref=None):
        ...
        parlist = []
        for member in self.members:
            parlist = parlist + member.buildPars(ref=_field,def_wcs=def_wcs)
    ...
    def computeOffsets(self):
        ...
        for member in self.members:
            ...
            self.pars[memname]['xoff'] = xoff
            self.pars[memname]['yoff'] = yoff
            self.pars[memname]['rot'] = in_wcs.orient - ref_wcs.orient

#
#
def selectInstrument(filename,output,pars=None):
    """
...
def runDrizzle(parlist,tdriz=None):
    ...
    for plist in parlist:
        ...
        iraf.drizzle.shft_fr='output'
        iraf.drizzle.shft_un='output'
