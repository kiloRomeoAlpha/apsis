...
# $Id: colorCatalog.py,v 1.20 2003/12/08 23:14:13 anderson Exp $
# ---------------------------------------------------------------------

__version__      = '$Revision: 1.20 $ '[11:-3]
__version_date__ = '$Date: 2003/12/08 23:14:13 $ '[7:-3]
...
class colorCatalog:
    ...
    an ACS pipeline DataSet object and looks for a detectionImage catalog and 
    ...
    def __init__(self,obs,catalogList,excludeList=["X_IMAGE", "Y_IMAGE", "FWHM_IMAGE"]):
        ...
        self.columnsPopList = []
        self.detectionImage = os.path.join(obs.newfits,"detectionImage.fits")
        ...
        if not os.path.exists(os.path.join(self.obsCats,"detectionImage.cat")):
        ...
        self.detCatalog = os.path.join(self.obsCats,'detectionImage.cat')
...
#----------------------------------------------------------------------------------------------------#
    ...
    def _writeColumns(self,header):
        ...
        cfile.write('## (This file was generated automatically by the ACS Pipeline.  Do not edit.)\n##\n')
        ...
        for i in range(len(header)):
            ...
            if len(line) < 3:
                ...
                if colname=='HST_ACS_WFC_F814W' or colname=='HST_ACS_WFC_F775W':
                    n_mo=str(col)
